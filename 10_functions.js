describe("Function", function() {
    ...
    it("can have method", function() {
        ...
        f.m = function() { return 2 }; // set a new property m on f, with a value of a function that return the value 2
        expect(f()).toEqual(1);
        expect(f.m()).toEqual(2);
    });

    it("can be passed as parameter", function() {
        let f = function() { return 1 }; // create a function that return the value 1
        let fu = function(a) {
            return a() + 1;
        };
    ...
    it("can be returned by a function", function() {
        let f = function() {
            let fu = function() { return 3 }; // create a function that return the value 3
